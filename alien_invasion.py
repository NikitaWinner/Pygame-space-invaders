...
class AlienInvasion:
    ...
    def __init__(self):
        ...
        pygame.init()
        # Загрузка звуковых эфектов
        self.shot = pygame.mixer.Sound('sounds/shot.ogg')
        ...
        self.play_button = Button(self, "play.bmp")
        # Создание коробля
        self.ship = Ship(self)
    ...
    def _update_screen(self):
        ...
        # Отрисовка фона изображения
        self.screen.blit(self.background, (0, 0))
        # Назначение цвета фона.
        # self.screen.fill(self.settings.bg_color)
        # Отображание изображение ракеты
        self.ship.blitme()
        # Отрисовка пуль ракеты ракеты
